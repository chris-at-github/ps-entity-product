...
class ProductRecordLinkHandlerService {
	...
	/**
	 * @param LinkResult $configuration Current field configuration
	 ...
	 */
	public function createProductLink($linkResult, array $options) {
		$productUid = (int) $this->contentObjectRenderer->cObjGetSingle($options['productUid'], $options['productUid.']);
		...
		$linkResult = $linkResult->withAttribute('href', $this->contentObjectRenderer->typoLink('', $parameters));
